//! The loopback HTTP client (the family pattern: hand-rolled,
//! http:// only, short timeouts). Shared by the orchestrator and the
//! walkthrough seed.
...
pub fn post(port: u16, path: &str, body: &str, timeout: Duration) -> Option<HttpText> {
